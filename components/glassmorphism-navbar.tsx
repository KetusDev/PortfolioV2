...
export default function GlassmorphismNavbar() {
  ...
  return (
    <>
      ...
      >
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-full px-8 py-4 shadow-2xl">
                      ...
                      >
                        {languages.map((lang) => (
                          <motion.button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-xl transition-colors duration-200 flex items-center space-x-2 ${
                              language === lang.code
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-20 left-1/2 transform -translate-x-1/2 backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-6 shadow-2xl min-w-[280px]"
            >
              <div className="flex flex-col space-y-4">
                {navItems.map((item, index) => (
                  <motion.button
                    key={item}
                    onClick={() => scrollToSection(item)}
                    className="text-black/80 hover:text-black transition-colors duration-300 font-medium text-left py-2"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
